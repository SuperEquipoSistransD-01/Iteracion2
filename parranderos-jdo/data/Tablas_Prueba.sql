...
values ('Bogota',	'Salitre',	191,	'nextVakAxion',	15000,	7500,	17);
...
insert into pedidos (codigo,	ciudadSucursal,	direccionSucursal,	proveedor,	producto,	precioVentaProducto,	precioCompraProducto,	nivelReorden,	diasDesdePedido,	volumenProducto,	diasParaEntrega,	llego)
values (210,	'Bogota',	'Salitre',	191,	171,	15000,	7500,	17,	3,	51,	1,	0);

insert into pedidos (codigo,	ciudadSucursal,	direccionSucursal,	proveedor,	producto,	precioVentaProducto,	precioCompraProducto,	nivelReorden,	diasDesdePedido,	volumenProducto,	diasParaEntrega,	llego)
values (211,	'Cali',	'La 14',	189,	170,	8000,	4000,	12,	4,	36,	2,	0);

insert into pedidos (codigo,	ciudadSucursal,	direccionSucursal,	proveedor,	producto,	precioVentaProducto,	precioCompraProducto,	nivelReorden,	diasDesdePedido,	volumenProducto,	diasParaEntrega,	llego)
values (212,	'Bogota',	'Calle 140',	189,	169,	10000,	5000,	15,	5,	45,	3, 1);

insert into bodegas (codigo,	ciudadSucursal,	direccionSucursal,	categoriaAlmacenamieto,	volumenLimite)
...
insert into compras(codigo,	fecha,	CiudadSucursal,	DireccionSucursal)
values (710,	TO_DATE('17/10/2022', 'DD/MM/YYYY'),	'Bogota',	'Calle 140');

insert into compras(codigo,	fecha,	CiudadSucursal,	DireccionSucursal)
values (711,	TO_DATE('16/10/2022', 'DD/MM/YYYY'),	'Cali',	'La 14');

insert into compras(codigo,	fecha,	CiudadSucursal,	DireccionSucursal)
values (712,	TO_DATE('15/12/2022', 'DD/MM/YYYY'),	'Bogota',	'Salitre');

insert into CantProductosComprados (Compra,	Producto,	CantPorProducto)
values (710,	169,	1);
