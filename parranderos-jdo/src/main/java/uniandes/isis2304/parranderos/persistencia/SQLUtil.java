...
class SQLUtil
{
	...
	{
        Query q = pm.newQuery(SQL, "SELECT "+ "Superandes_sequence" + ".nextval FROM DUAL");
	...
	public long [] limpiarParranderos (PersistenceManager pm)
	{
        ...
        long sirvenEliminados = 0;
        long visitanEliminadas = 0;
        long bebidasEliminadas = 0;
        long tiposBebidaEliminados = 0;
        return new long[] {gustanEliminados, sirvenEliminados, visitanEliminadas, bebidasEliminadas, 
        		tiposBebidaEliminados};
	}
